...
export default function HomePage() {
  ...
  const handleDiscordLogin = () => {
    ...
    window.location.href = `https://discord.com/api/oauth2/authorize?client_id=YOUR_CLIENT_ID&redirect_uri=${encodeURIComponent(window.location.origin + "/auth/discord")}&response_type=code&scope=identify%20email`
  }
                        ...
                        <tr key={sheet.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center justify-between">
                              ...
                              <Button onClick={() => router.push(`/spreadsheet-login/${sheet.id}`)}>
                                E-Tabloya Gir
                              </Button>
                            </div>
                          </td>
